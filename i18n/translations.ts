export const translations = {
  en: {
    ...
    detail: {
      ...
      previewTitle: "Order image — screenshot it to send the customer",
      previewHint: "Press and hold the image to save, or take a screenshot",
  ...
  vi: {
    ...
    detail: {
      ...
      previewTitle: "Ảnh đơn — chụp màn hình để gửi khách",
      previewHint: "Nhấn giữ ảnh để lưu, hoặc chụp màn hình",
