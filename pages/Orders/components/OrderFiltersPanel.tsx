...
const OrderFiltersPanel: React.FC<Props> = ({ initialValues, creatorOptions, onApply, onCollapse }) => {
  ...
  return (
    <Box
      layoutClassName="flex shrink-0 flex-col gap-4 p-4 sm:p-5"
    ...
    >
      ...
      <Box layoutClassName="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:justify-end">
        <Button
          type="button"
          ...
          sizeClassName="px-5 py-2.5 text-sm"
        ...
        <Button
          ...
          layoutClassName="inline-flex w-full items-center justify-center gap-1 sm:w-auto"
          stateClassName="transition-colors"
          variant="ghost"
          disableVariantHover
          disableVariantTextColor
