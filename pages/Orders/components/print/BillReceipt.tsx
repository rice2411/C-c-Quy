    ...
    <Box layoutClassName="w-full px-0 py-1 leading-tight" backgroundClassName="bg-white" textClassName="text-black">
      ...
      {qrUrl ? (
        <Box layoutClassName={`${dashed} flex flex-col items-center gap-0.5 pt-1`}>
          ...
          {accountHolder ? <Typography as="p" layoutClassName="text-[12px] font-medium text-center" textClassName="text-black">{accountHolder.toUpperCase()}</Typography> : null}
          {description ? <Typography as="p" layoutClassName="text-[12px] text-center" textClassName="text-black">Nội dung: <Typography as="span" layoutClassName="font-mono font-semibold text-[12px]" textClassName="text-black">{description}</Typography></Typography> : null}
        </Box>
      ) : null}
